...
void Blowfish_Encrypt1(BLOWFISH_CTX* ctx, unsigned long* xl, unsigned long* xr) {
    unsigned long  Xl;
    unsigned long  Xr;
    unsigned long  temp;
    short       i;
    ...
    Xr = Xr ^ ctx->P[N];
    Xl = Xl ^ ctx->P[N + 1];
    printf("%08lX %08lX---TEXTUL CRIPTAT\n", Xr, Xl);
    q++;
    *xl = Xl;
    *xr = Xr;
}
...
void Blowfish_Decrypt(BLOWFISH_CTX* ctx, unsigned long* xl, unsigned long* xr) {
    ...
    Xl = *xl;
    Xr = *xr;
    float q = 1; printf("%08lX %08lX---TEXTUL CRIPTAT\n", Xr, Xl);
    for (i = N + 1; i > 1; --i) {
        Xl = Xl ^ ctx->P[i];
        Xr = F(ctx, Xl) ^ Xr;
        printf("%08lX %08lX---RUNDA %d\n", Xr, Xl,18-i);
    ...
    Xr = Xr ^ ctx->P[1];
    Xl = Xl ^ ctx->P[0];
    printf("%08lX %08lX---TEXTUL DECRIPTAT\n", Xr, Xl);
    q++;
    *xl = Xl;
    *xr = Xr;
}
